    ...
    testList
        ...
        [
            ...
            <| fun _ ->
                ...
                Expect.isTrue
                    (verdict.Reasons |> List.exists (_.Contains("static blocker")))
                    "blocker rebuild failure is named"
            ...
            <| fun _ ->
                ...
                Expect.isTrue
                    verdict.Passed
                    "preindexed blockers, bounded search, compact scene, and full interpolation pass"
            ...
            <| fun _ ->
                ...
                Expect.isTrue
                    (verdict.Reasons |> List.exists (_.Contains("moving entities")))
                    "failure names interpolation coverage"
            ...
            <| fun _ ->
                ...
                Expect.isTrue
                    (Trace.equalFrames a.Trace b.Trace)
                    "wall-clock observations do not contaminate trace frames"
            ...
            <| fun _ ->
                ...
                Expect.equal
                    (item.GetProperty("sceneNodesByLayer").GetProperty("product-scene").GetInt32())
                    146
                    "scene schema is compatible"
        ]
