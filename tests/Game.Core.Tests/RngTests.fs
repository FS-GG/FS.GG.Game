...
let tests =
    testList
        "Game.Core Rng SplitMix64 (US2, FR-006..FR-008)"
        [
            ...
            testCase "nextInt stays within [lo, hi] inclusive (FsCheck ≥1000 cases)"
            <| fun () ->
            ...
            testCase "nextFloat stays in [0.0, 1.0) (FsCheck ≥1000 cases)"
            <| fun () ->
