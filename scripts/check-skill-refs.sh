...
# ────────────────────────────────────────────────────────────────────────────────────────────────
#
# A self-qualified ref that resolves is accepted, a typo'd owner is caught, a self-qualified ref to
# a skill we do not publish is dangling, and a bare ref we do not publish is dangling.
