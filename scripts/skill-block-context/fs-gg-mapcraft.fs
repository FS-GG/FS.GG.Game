...
//#block 5 "let isOrthogonallyConnected (expectedCount: int) (layout: FloorLayout) ="
// Exact-budget floors: this block is self-contained and exercises the real FloorLayout/Rng surface.

//#block 6 "let struct (mz, rng1) = MapGen.maze 31 21 rng"
...
//#block 7 "let reached   = MapAnalysis.reachable FourWay 4096 isFloor { Col = 1; Row = 1 }   // Set<Cell> reachable from a start"
...
//#block 8 "let rules = [ Connected; MinDiameter 20; MinBorderOpenings 2; MaxComponents 1 ]"
...
//#block 9 "let hasLos (a: Cell) (b: Cell) = Los.lineOfSight (fun c -> MapGen.get level c = ValueSome Floor) a b"
