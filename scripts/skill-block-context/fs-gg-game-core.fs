...
// binding here MAY forward-reference a type the block itself declares below it (block 9's `creeps`
// is exactly that). Blocks 2, 3, 4, 5, 7 and 10 are self-contained and need no section.
//
...
//#block 6 "let reach = Pathfinding.reachable FourWay 4096 cost canEndOn (Pathfinding.budgetFor unit.Move) unit.Cell"
